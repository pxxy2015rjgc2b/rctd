...
//				String password=user_password;
				if (user.getUser_password().equals(password)) {
					...
					ActionContext.getContext().getSession().put("user_username", user.getUser_username());
					ActionContext.getContext().getSession().put("user_name", user.getUser_name());
					ActionContext.getContext().getSession().put("user_telphone", user.getUser_telphone());
					ActionContext.getContext().getSession().put("user_userRight", user.getUser_userRight());
					ActionContext.getContext().getSession().put("user_export_Right", user.getUser_export_Right());
					ActionContext.getContext().getSession().put("user_manage_Right", user.getUser_manage_Right());
		...
		public void getUserById() throws IOException {
			...
			response.setContentType("text/html;charset=utf-8");
			PrintWriter pw = response.getWriter();
			rctd_user ru = userService.getUserById(user_id);
			Gson gson = new Gson();
