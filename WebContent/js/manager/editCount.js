...
/*var updateList = function(event) {
 ...
 window.location.href = "/rctd/manager/manager_updateList?list.rctd_list_id="
 + editId;
 }*/

function editCount(event) {
	// var editIds=document.getElementsByName("edit");
	// for(var i=0;i<editIds.length;i++){
	// var editId=editIds[i].parentNode.parentNode.children[0].innerHTML;
	// console.log(editId);
	// }
	var editId = event.id;
	var jc = $
			.confirm({
				...
				content : "<div id='confirmDiv'><form id='formDataIntroduce' name='formDataIntroduce'>"
						...
						+ '<tr style="display:none;"><th><span style="color:red;">*&nbsp;</span>ID：</th><td><input type="text" id="rctd_list_id" class="form-control"/></td></tr>'
						...
						+ '<tr><th><span style="color:red;">*&nbsp;</span>手机号：</th><td><input type="text" id="list_telephone" class="form-control" /></td></tr>'
